function [global_x ,fit_gen]=psoformsvm(X,Y,Xt,Yt)
%% 参数初始化
if nargin == 4
    pso_option = struct('c1',0.9,'c2',0.9,'maxgen',100,'sizepop',20, ...
        'k',0.6,'wV',0.9,'wP',0.9, ...
        'popcmax',10^3,'popcmin',10^(-3),'popgmax',10^3,'popgmin',10^(-3));
end
